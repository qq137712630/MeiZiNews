...
public class VideoApi {
    ...
    //分类内容列表：http://www.douyu.com/directory/game/DOTA2?page=2&isAjax=1
    public static final String DY_WEB_DIRECTORY_GAME = "directory/game/";

    public static final String DY_HTML5 = "http://m.douyu.com/html5/";

    //房间信息:http://m.douyu.com/html5/live?roomId=73334
