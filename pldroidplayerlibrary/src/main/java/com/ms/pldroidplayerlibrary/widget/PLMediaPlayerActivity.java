package com.ms.pldroidplayerlibrary.widget;
...
import com.ms.pldroidplayerlibrary.R;
...
public class PLMediaPlayerActivity extends AppCompatActivity {
    ...
    protected static final String TAG = PLMediaPlayerActivity.class.getSimpleName();
    ...
    protected SurfaceHolder.Callback mCallback = new SurfaceHolder.Callback() {
    ...
    protected PLMediaPlayer.OnVideoSizeChangedListener mOnVideoSizeChangedListener = new PLMediaPlayer.OnVideoSizeChangedListener() {
    ...
    protected PLMediaPlayer.OnPreparedListener mOnPreparedListener = new PLMediaPlayer.OnPreparedListener() {
        @Override
    ...
    protected PLMediaPlayer.OnInfoListener mOnInfoListener = new PLMediaPlayer.OnInfoListener() {
        @Override
    ...
    protected PLMediaPlayer.OnBufferingUpdateListener mOnBufferingUpdateListener = new PLMediaPlayer.OnBufferingUpdateListener() {
        @Override
     ...
     *
     */
    protected PLMediaPlayer.OnCompletionListener mOnCompletionListener = new PLMediaPlayer.OnCompletionListener() {
        @Override
    ...
    protected boolean isLiveStreaming(String url) {
